...
type TriggerProp<T = string> = boolean | StaticAnimations | T | (string & {});
...
function AnimateIcon({
  ...
  const handleClick = composeEventHandlers<React.MouseEvent<HTMLElement>>(
    childProps.onClick,
    () => {
      if (animateOnClick) startAnimation(animateOnClick);
    },
  );
