  ...
  try {
    ...
    if (!result.success) {
      return NextResponse.json(
        { success: false, error: "Invalid contact form data payload." },
        { status: 400 }
      );
    }
    ...
    const fromEmail = "Antilinear Onboarding <onboarding@mail.antilineartech.com>";
    const toEmail = ["support@antilineartech.com"];
